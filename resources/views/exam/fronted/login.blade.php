...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('storage/exam/fronted/images/'. $setting->value('school_logo'))}}">
    ...
    <script src="{{asset('assets/apps/exam/fronted/login.js')}}"></script>
</head>
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        ...
                        <div class="form-group form-group-feedback form-group-feedback-right">
                            <input type="text" name="student_username" class="form-control" placeholder="Nama Pengguna">
                            <div class="form-control-feedback">
                                <i class="icon-user text-muted"></i>
                            </div>
                        </div>
                        <div class="form-group form-group-feedback form-group-feedback-right">
                            <input type="password" name="student_password" class="form-control" placeholder="Kata Sandi">
                            <div class="form-control-feedback">
