        ...
        <div class="sidebar-content">
            <div class="sidebar-user">
                <div class="card-body">
                    <div class="media">
                        <div class="mr-2">
                            <a href="#"><img src="{{(asset($setting->value('school_logo') == null ? 'assets/apps/portal/images/kemenag.png' : 'storage/portal/images/' . $setting->value('school_logo')))}}" width="40" height="40" alt=""></a>
                        </div>
