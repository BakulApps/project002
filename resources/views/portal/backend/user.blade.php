@extends('portal.backend.layouts.master', ['title' => 'Pengguna'])
@section('jsplugin')
...
@endsection
@section('jsscript')
    <script src="{{asset('assets/apps/portal/backend/js/user.js')}}"></script>
@endsection
@section('breadcrumb')
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="user_facebook" placeholder="muhammaddarmanto" class="form-control">
                            </div>
                            <div class="col-md-4">
                                <label>Instagram :</label>
                                <input type="text" id="user_instagram" placeholder="muhammaddarmanto" class="form-control">
                            </div>
                            <div class="col-md-4">
                                <label>Twitter :</label>
                                <input type="text" id="user_twitter" placeholder="muhammaddarmanto" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
