...
<html lang="{{Str::of(config('app.locale'))->replace('_', '-')}}">
    @include('admission.fronted.layouts.head')
    <body>
        ...
        <div class="page-content">
            <div class="sidebar sidebar-dark sidebar-main sidebar-expand-md">
                ...
                <div class="sidebar-content">
                    ...
                    @include('admission.fronted.layouts.mainmenu')
                </div>
            </div>
            <div class="content-wrapper">
                @include('admission.fronted.layouts.header')
                <div class="content">
                    @yield('content')
                </div>
                @include('admission.fronted.layouts.footer')
            </div>
        </div>
    @yield('modal')
    </body>
