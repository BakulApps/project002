<div class="card card-sidebar-mobile">
    <ul class="nav nav-sidebar" data-nav-type="accordion">
        ...
        @if(Session::has('auth'))
        <li class="nav-item"><a href="{{route('admission.invoice')}}" class="nav-link {{$title == 'Pembayaran Tagihan' ? 'active' : null}}"><i class="icon-coin-dollar"></i><span>Pembayaran</span></a></li>
        @endif
