...
@endsection
@section('jsscript')
    <script src="{{asset('assets/apps/admission/backend/js/student_edit.js')}}"></script>
@endsection
@section('breadcrumb')
    <span class="breadcrumb-item">Siswa</span>
    <span class="breadcrumb-item active">Ubah Siswa</span>
@endsection
@section('content')
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-white header-elements-sm-inline">
                    <h5 class="card-title font-weight-semibold">UBAH SISWA</h5>
                </div>
                <div class="card-body">
                    <div class="card">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <select id="student_gender" data-placeholder="Pilih Jenis Kelamin" class="form-control select2">
                                                <option value="{{$student->student_gender}}" selected>{{\App\Models\Master\Gender::name($student->student_gender)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="student_religion" data-placeholder="Pilih Agama" class="form-control select2">
                                                <option value="{{$student->student_religion}}" selected>{{\App\Models\Master\Religion::name($student->student_religion)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <select id="student_civic" data-placeholder="Pilih Kewarganegaraan" class="form-control select2">
                                                <option value="{{$student->student_civic}}" selected>{{\App\Models\Master\Civic::name($student->student_civic)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="student_hobby" data-placeholder="Pilih Hobi" class="form-control select2">
                                                <option value="{{$student->student_hobby}}" selected>{{\App\Models\Student\Hobby::name($student->student_hobby)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="student_purpose" data-placeholder="Pilih Cita-cita" class="form-control select2">
                                                <option value="{{$student->student_purpose}}" selected>{{\App\Models\Student\Purpose::name($student->student_purpose)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="checkbox" class="form-check-input-styled" id="student_im_hepatitis" {{$student->student_im_hepatitis == 1 ? "checked" : null}}>Hepatitis</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-check">
                                                        <label class="form-check-label"><input type="checkbox" class="form-check-input-styled" id="student_im_polio" {{$student->student_im_polio == 1 ? "checked" : null}}>Polio</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-check">
                                                        <label class="form-check-label"><input type="checkbox" class="form-check-input-styled" id="student_im_bcg" {{$student->student_im_bcg == 1 ? "checked" : null}}>BCG</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-check">
                                                        <label class="form-check-label"><input type="checkbox" class="form-check-input-styled" id="student_im_campak" {{$student->student_im_campak == 1 ? "checked" : null}}>Campak</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-check">
                                                        <label class="form-check-label"><input type="checkbox" class="form-check-input-styled" id="student_im_dpt" {{$student->student_im_dpt == 1 ? "checked" : null}}>DPT</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-check">
                                                        <label class="form-check-label"><input type="checkbox" class="form-check-input-styled" id="student_im_covid" {{$student->student_im_covid == 1 ? "checked" : null}} >Covid-19</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select id="student_residence" data-placeholder="Pilih Tempat Tinggal" class="form-control select2">
                                                <option value="{{$student->student_residence}}" selected>{{\App\Models\Student\Residence::name($student->student_residence)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="student_province" data-placeholder="Pilih Propinsi" class="form-control select2">
                                                <option value="{{$student->student_province}}" selected>{{\App\Models\Master\Territory::province($student->student_province)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="student_distric" data-placeholder="Pilih Kebupaten/Kota" class="form-control select2">
                                                <option value="{{$student->student_distric}}" selected>{{\App\Models\Master\Territory::distric($student->student_distric)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="student_subdistric" data-placeholder="Pilih Kecamatan" class="form-control select2">
                                                <option value="{{$student->student_subdistric}}" selected>{{\App\Models\Master\Territory::subdistric($student->student_subdistric)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="student_village" data-placeholder="Pilih Kelurahan/Desa" class="form-control select2">
                                                <option value="{{$student->student_subdistric}}" selected>{{\App\Models\Master\Territory::village($student->student_subdistric, $student->student_village)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="student_distance" data-placeholder="Pilih Jarak Tempat Tinggal" class="form-control select2">
                                                <option value="{{$student->student_distance}}" selected>{{\App\Models\Master\Distance::name($student->student_distance)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="student_transport" data-placeholder="Pilih Transportasi" class="form-control select2">
                                                <option value="{{$student->student_transport}}" selected>{{\App\Models\Master\Transport::name($student->student_transport)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="student_travel" data-placeholder="Pilih Waktu Tempuh" class="form-control select2">
                                                <option value="{{$student->student_travel}}" selected>{{\App\Models\Master\Travel::name($student->student_travel)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="student_program" data-placeholder="Pilih Program" class="form-control select2">
                                                <option value="{{$student->student_program}}" selected>{{\App\Models\Student\Program::name($student->student_program)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="student_boarding" data-placeholder="Pilih Boarding" class="form-control select2">
                                                <option value="1" @if($student->student_boarding == 1) selected @endif>Ya</option>
                                                <option value="2" @if($student->student_boarding == 2) selected @endif>Tidak</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="student_home_province" data-placeholder="Pilih Propinsi" class="form-control select2">
                                                <option value="{{$student->student_home_province}}" selected>{{\App\Models\Master\Territory::province($student->student_home_province)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="student_home_distric" data-placeholder="Pilih Kebupaten/Kota" class="form-control select2">
                                                <option value="{{$student->student_home_distric}}" selected>{{\App\Models\Master\Territory::distric($student->student_home_distric)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="student_home_subdistric" data-placeholder="Pilih Kecamatan" class="form-control select2">
                                                <option value="{{$student->student_home_subdistric}}" selected>{{\App\Models\Master\Territory::subdistric($student->student_home_subdistric)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="student_home_village" data-placeholder="Pilih Kelurahan/Desa" class="form-control select2">
                                                <option value="{{$student->student_home_village}}" selected>{{\App\Models\Master\Territory::village($student->student_home_subdistric, $student->student_home_village)}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="student_swaphoto" data-placeholder="Pilih Status Berkas.." class="form-control select2">
                                            <option></option>
                                            <option value="1" @if($student->student_swaphoto == 1) selected @endif>1. Berkas Ada</option>
                                            <option value="2" @if($student->student_swaphoto == 0) selected @endif>1. Berkas Tidak Ada</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="student_akta_photo" data-placeholder="Pilih Status Berkas.." class="form-control select2">
                                            <option></option>
                                            <option value="1" @if($student->student_akta_photo == 1) selected @endif>1. Berkas Ada</option>
                                            <option value="2" @if($student->student_akta_photo == 0) selected @endif>1. Berkas Tidak Ada</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="student_kk_photo" data-placeholder="Pilih Status Berkas.." class="form-control select2">
                                            <option></option>
                                            <option value="1" @if($student->student_kk_photo == 1) selected @endif>1. Berkas Ada</option>
                                            <option value="2" @if($student->student_kk_photo == 0) selected @endif>1. Berkas Tidak Ada</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="student_ijazah_photo" data-placeholder="Pilih Status Berkas.." class="form-control select2">
                                            <option></option>
                                            <option value="1" @if($student->student_ijazah_photo == 1) selected @endif>1. Berkas Ada</option>
                                            <option value="2" @if($student->student_ijazah_photo == 0) selected @endif>1. Berkas Tidak Ada</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="student_skhun_photo" data-placeholder="Pilih Status Berkas.." class="form-control select2">
                                            <option></option>
                                            <option value="1" @if($student->student_skhun_photo == 1) selected @endif>1. Berkas Ada</option>
                                            <option value="2" @if($student->student_skhun_photo == 0) selected @endif>1. Berkas Tidak Ada</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card">
                ...
                <div class="card-footer bg-white d-flex justify-content-between align-items-center">
                    ...
                    <form method="post" action="{{route('admission.register')}}">
                        ...
                        @csrf
                        <button type="submit" class="btn bg-success btn-labeled btn-labeled-left" name="_type" value="print" @if($compelete == false) disabled @endif><b><i class="icon-printer"></i></b> CETAK</button>
                    </form>
                </div>
            </div>
        </div>
