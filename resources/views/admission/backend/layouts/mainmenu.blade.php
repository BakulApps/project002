    ...
    <ul class="nav nav-sidebar" data-nav-type="accordion">
        ...
        <li class="nav-item nav-item-submenu">
            ...
            <ul class="nav nav-group-sub" data-submenu-title="Master Data">
                ...
                <li class="nav-item"><a href="{{route('admission.admin.master.bank')}}" class="nav-link">Data Bank</a></li>
        ...
        <li class="nav-item"><a href="{{route('admission.admin.payment')}}" class="nav-link {{$title == 'Pembayaran' ? 'active' : null}}"><i class="icon-credit-card"></i><span>Data Pembayaran</span></a></li>
