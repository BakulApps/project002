        ...
        <ul class="nav nav-sidebar" data-nav-type="accordion">
            ...
            <li class="nav-item nav-item-submenu">
                ...
                <ul class="nav nav-group-sub" data-submenu-title="Postingan">
                    ...
                    <li class="nav-item"><a href="{{route('graduate.admin.master.school')}}" class="nav-link">Data Lembaga</a></li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href="{{route('graduate.admin.value')}}" class="nav-link {{$title == 'Nilai' ? 'active' : null}}"><i class="icon-pencil"></i><span>Penilaian</span></a></li>
